      ...
      <div className="setup-grid">
        <div className="input-group">
          ...
          <select
            ...
            onChange={(e) =>
              handleInputChange(
                "tournamentType",
                e.target.value as "round-robin" | "rapid-swiss"
              )
            }
          >
            ...
            <option value="rapid-swiss">
              Rapid Swiss (Real-time pairing as matches finish)
            </option>
          </select>
        </div>
        ...
        <div className="input-group">
          ...
          <select
            ...
            onChange={(e) =>
              handleInputChange("numRounds", parseInt(e.target.value))
            }
          >
        ...
        <div className="input-group">
          ...
          <input
            ...
            max="25"
            onChange={(e) =>
              handleInputChange("maxPoints", parseInt(e.target.value))
            }
          />
        </div>
        ...
        <div className="input-group">
          ...
          >
            ...
            <option value="rapid-swiss">
              Rapid Swiss - Score-based pairing with automatic match generation
            </option>
          </select>
        </div>
        ...
        {tournament.tournamentType === "rapid-swiss" && (
          <div className="input-group">
            ...
            >
              <option value="0">
                0 points - Only pair players with exact same score
              </option>
              <option value="1">
                1 point - Allow pairing players within 1 point difference
              </option>
            </select>
          </div>
        )}
        ...
        <div className="input-group">
          ...
          <select
            ...
            onChange={(e) =>
              handleInputChange(
                "rankingSystem",
                e.target.value as "standard" | "hybrid"
              )
            }
          >
            <option value="standard">
              Standard - All positions by points + tiebreakers
            </option>
            <option value="hybrid">
              Hybrid - Top by points, lower by ELO improvement
            </option>
          </select>
        </div>
        ...
        {(tournament.tournamentType || "round-robin") === "rapid-swiss" && (
          <div className="input-group">
            <label htmlFor="allowPointDifference">
              Point Difference Tolerance
            </label>
            <select
              ...
              onChange={(e) =>
                handleInputChange(
                  "allowPointDifference" as keyof Tournament,
                  parseInt(e.target.value)
                )
              }
            >
              <option value="0">
                Strict (0) - Players must have same points to pair
              </option>
              <option value="1">
                Flexible (1) - Players within 1 point can pair
              </option>
            </select>
            <small
              style={{
            ...
            >
              Strict mode requires exact point matches. Flexible mode allows
              pairing players with different point totals.
            </small>
          </div>
        )}
      </div>

      <button className="btn" onClick={handleGoToPlayerSetup}>
        Setup Players →
      </button>
    </div>
  );
