...
const MainContent: React.FC<MainContentProps> = ({
  ...
  const defaultTab =
    tournament.tournamentType === "rapid-swiss" ? "swiss" : "matches";
  const [activeTab, setActiveTab] = useState<
    "swiss" | "matches" | "table" | "standings" | "stats"
  >(defaultTab);
  ...
  return (
    <div className="main-content">
      ...
      <div className={`tab-content ${activeTab === "matches" ? "active" : ""}`}>
        {hasMatches || isSwiss ? (
          ...
          <div style={{ textAlign: "center", padding: "40px" }}>
            ...
            <p>
              Tournament matches haven't been generated yet. Please make sure
              you've set up players and started the tournament properly.
            </p>
          </div>
        )}
      </div>
      ...
      <div
        className={`tab-content ${activeTab === "standings" ? "active" : ""}`}
      >
