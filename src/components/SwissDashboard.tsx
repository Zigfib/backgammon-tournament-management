          ...
          <div style={{ padding: '20px', backgroundColor: '#e7f3ff', border: '1px solid #bee5eb', borderRadius: '8px' }}>
              ...
              <div>
                ...
                <select
                  ...
                  style={{
                    ...
                    borderRadius: '4px',
                    fontSize: '14px',
                    backgroundColor: manualPlayer1 === null ? '#f8f9fa' : 'white',
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button
                ...
                style={{
                  padding: '8px 16px',
                  backgroundColor: (manualPlayer1 === null || manualPlayer2 === null) ? '#6c757d' : '#28a745',
                  color: 'white',
                  border: 'none',
                  borderRadius: '4px',
                  cursor: (manualPlayer1 === null || manualPlayer2 === null) ? 'not-allowed' : 'pointer',
                  fontSize: '14px'
                }}
              >
                Submit Pairing
